...
class AuthCubit extends Cubit<AuthState> {
  ...
  Future<void> signIn(String email, String password) async {
    ...
    result.fold(
      (failure) => emit(AuthErrorSignIn(failure.message)),
      (user) => emit(AuthSuccessSignIn(user)),
    );
  }
  ...
  Future<void> signUp(String email, String password, String name) async {
    ...
    result.fold(
      (failure) => emit(AuthErrorSignUp(failure.message)),
      (user) => emit(AuthSuccessSignUp(user)),
    );
  }
}
